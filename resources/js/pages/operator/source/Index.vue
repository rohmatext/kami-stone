...
<template>
    ...
    <AppLayout>
        <Page title="Sumber" max-width="sm">
            ...
            <CreateSourceSheet v-model="show.create" @success="onCreated" />
            <EditSourceSheet v-model="show.edit" @success="onUpdated" />
            <InactiveSourceDialog v-model="show.inactive" @success="onInactivated" />
        </Page>
    </AppLayout>
</template>
